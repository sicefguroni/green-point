...
interface SimulationInputsModel {
...
interface SimulationInputsProps {
  inputs: SimulationInputsModel;
  onInputChange: <K extends keyof SimulationInputsModel>(
    key: K,
    value: SimulationInputsModel[K],
  ) => void;
  onReset: () => void;
  baselineData: BaselineData;
}

type InputGroup = "climate" | "greening" | "budget" | "time";
...
const SimulationInputs = ({ inputs, onInputChange, onReset, baselineData }: SimulationInputsProps) => {
  ...
  const toggleGroup = (group: InputGroup) => {
