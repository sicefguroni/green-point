      ...
      >
        ...
        <div className="flex items-start gap-3 mb-3">
          ...
          <div className="flex-1">
            <h2 className="text-lg font-semibold text-neutral-black mb-1">{title}</h2>
            <div className="text-neutral-black/70 text-sm leading-[1.6]">
              <div className="mb-3">
                <h3 className="font-medium text-sm text-neutral-black/90 mb-1">What it is</h3>
                <p>{what ?? defaultWhat}</p>
              </div>
              <div>
                <h3 className="font-medium text-sm text-neutral-black/90 mb-1">Why it matters</h3>
                <p>{why ?? defaultWhy}</p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-4 bg-green-50 border border-green-100 p-3 rounded-md">
          <div className="flex items-start gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-green-600 mt-0.5" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 2C8 6 6 8 6 11c0 3 2 5 6 9 4-4 6-6 6-9 0-3-2-5-6-9z" />
            </svg>
            <div className="text-sm">
              <div className="font-semibold text-neutral-black">AI Insight</div>
              <div className="text-neutral-black/70 text-sm leading-[1.4]">In Mandaue, increasing this by 5% could lower local temperatures by 1°C.</div>
            </div>
          </div>
        </div>
    ...
    >
      ...
      >
        ...
        <div className="mt-4 bg-sky-50 border border-sky-100 p-3 rounded-md">
          <div className="flex items-start gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-sky-600 mt-0.5" viewBox="0 0 24 24" fill="currentColor">
              <path d="M3 3v18h18V3H3zm5 13H6v-6h2v6zm4 0h-2V8h2v8zm4 0h-2v-4h2v4z" />
            </svg>
            <div className="text-sm">
              <div className="font-semibold text-neutral-black">AI Insight</div>
              <div className="text-neutral-black/70 text-sm leading-[1.4]">Based on local data, a 10% shift in this series correlates with improved air quality during the dry season.</div>
            </div>
          </div>
        </div>
