...
function FacebookOAuthContent() {
    ...
    return (
        <div className="w-full max-w-lg p-8 bg-white shadow-lg rounded-lg text-center">
            ...
            <h1 className="text-2xl font-bold text-neutral-black mb-2">Facebook Authentication</h1>
            <p className="text-neutral-grey mb-6">Redirecting you to Facebook to sign in…</p>
