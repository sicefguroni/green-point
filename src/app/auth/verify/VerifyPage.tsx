            ...
            <div className="w-full max-w-lg overflow-hidden rounded-2xl border border-neutral-200/80 bg-white shadow-xl shadow-neutral-900/5">
                ...
                <div className="space-y-6 px-8 py-10">
                    <p className="text-center text-[15px] leading-relaxed text-neutral-700">
                        ...
                        . Tap <strong>Confirm</strong> in that email — you will be redirected to onboarding
                        and signed in automatically.
                    </p>

                    <ul className="space-y-3 rounded-xl border border-neutral-100 bg-neutral-50/80 p-4 text-sm text-neutral-600">
                        <li className="flex gap-3">
                            <Inbox className="mt-0.5 h-5 w-5 shrink-0 text-primary-green" aria-hidden />
                            <span>Check Promotions or Spam if you do not see it within a minute.</span>
                        </li>
                        <li className="flex gap-3">
                            <ShieldCheck className="mt-0.5 h-5 w-5 shrink-0 text-primary-green" aria-hidden />
                            <span>Keep this tab open; after confirming, the app will refresh into onboarding.</span>
                        </li>
                    </ul>
