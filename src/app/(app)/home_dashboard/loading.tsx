export default function HomeDashboardLoading() {
  return (
    <main className="relative flex min-h-screen max-w-screen flex-col bg-neutral-100 dark:bg-neutral-950 font-roboto transition-colors">
      <div className="h-16 w-full border-b border-neutral-200 dark:border-neutral-800 bg-white/80 dark:bg-neutral-900/80 animate-pulse" />
      <div className="relative w-full flex flex-col overflow-hidden px-4 md:px-10 py-32 gap-10">
        <div className="flex flex-col gap-4 max-w-xl">
          ...
          <div className="h-10 w-64 rounded-lg bg-neutral-200 dark:bg-neutral-700 animate-pulse" />
          <div className="h-4 w-full max-w-md rounded bg-neutral-200/80 dark:bg-neutral-700/80 animate-pulse" />
        </div>
