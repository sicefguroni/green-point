...
export default function BarangayGreeneryPage() {
  ...
  const [barangayDataMetrics, setBarangayDataMetrics] = useState<
    Record<string, BarangayDataMetrics>
  >({});

  const classColor = getGreeneryClassColor(
  ...
  const [temperatureTextColor, temperatureBgColor] =
    temperatureColor.split(" ");
    ...
    return (
      <div className="w-full h-fit bg-white rounded-lg shadow-md p-6">
        <p className="text-neutral-black/80">
          Select a barangay on the map to view detailed metrics.
        </p>
      </div>
    );
  }
      ...
      <div className="flex flex-col gap-4 mb-4">
        <div className="flex flex-row items-center justify-between">
          <div className="flex flex-row items-center gap-8">
            <h1
              className={`text-2xl font-bold ${textColor} ${bgColor} w-fit px-4 py-1 rounded-md`}
            >
        ...
        <div className="flex flex-row flex-wrap gap-12">
          ...
          <p className="text-neutral-black/80 font-medium">
            Flood Exposure:{" "}
            <span
              className={getFloodExposureClass(
                ...
                <CarouselItem className="h-full">
                  <div className="w-full h-60 mb-8 ">
                    <div className="flex flex-row justify-between items-center">
                      <h3 className="text-neutral-black text-sm font-medium mb-2">
                        NDVI & LST Trend
                      </h3>
                      <button
                        onClick={() =>
                  ...
                  <div className="w-full h-60">
                    ...
                    <TreeCanopyTrend
                      data={[
                        {
                          year: "2020",
                          canopy: selectedBarangay?.treeCanopy - 0.3 || 0,
                        },
                        {
                          year: "2021",
                          canopy: selectedBarangay?.treeCanopy - 0.23 || 0,
                        },
                        {
                          year: "2022",
                          canopy: selectedBarangay?.treeCanopy - 0.1 || 0,
                        },
                        {
                          year: "2023",
                          canopy: selectedBarangay?.treeCanopy + 0.1 || 0,
                        ...
                        {
                          year: "2024",
                          canopy: selectedBarangay?.treeCanopy + 0.15 || 0,
                        },
                      ]}
                      since="2020"
                      changePercent={5.3}
